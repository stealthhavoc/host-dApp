...
const CONTRACT_ADDRESS = "0x30a48f2282f29ed1d2f14c775e9c445f0e5a0b62"; 
...
export function App( props ) {  
    ...
    return (
        <Container style={{ padding:"0px", border:"1px solid black" }}>
            ...
            <Row>
                ...
                <Col style={{ "paddingRight":"0px", "borderRight":"2px solid black" }}>
                    <div style={{ "backgroundColor":"#fff0ec", "height":"100%", overflowY:"auto", backgroundImage:"url(https://wallpapercave.com/wp/wp2885476.jpg)"}}>
                          <Row style={{ marginRight:"0px" }}  >
                              <Card style={{ width:'100%', alignSelf:'center', marginLeft:"15px", fontSize:"25px", fontFamily:"sans-serif" }}>
                                <Card.Header>
                                    <b>Chats</b>
                                </Card.Header>
                              </Card>
                ...
                <Col xs={ 8 } style={{ "paddingLeft":"0px" }}>
                    <div style={{ "backgroundColor":"#fff0ec", "height":"100%", backgroundImage:"url(https://wallpapercave.com/wp/wp2885476.jpg)" }}>
                        ...
                        <div className="SendMessage"  style={{ borderTop:"2px solid black", position:"relative", bottom:"0px", padding:"10px 45px 0px 45px", margin:"119px 95px 0 0", width:"97%" }}>
                            <Form onSubmit={ (e) => {
			                	e.preventDefault();
